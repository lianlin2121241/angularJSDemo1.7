...
function config($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    $stateProvider
            ...
            resolve: {
                loadCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        files:['app/components/heroListComponent.js','app/components/heroDetailComponent.js','app/components/editableFieldComponent.js']
                    });
                }]
            }
        })
        .state('docsTabs', {
            url: '/docsTabs',
            templateUrl: 'app/pages/docsTabs.html',
            resolve: {
                loadCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        files:['app/components/myTabsComponent.js','app/components/myPaneComponent.js']
                    });
                }]
            }
        })
